...
func Test_repository_CreateUser(t *testing.T) {
	...
	tests := []struct {
			...
			mockFn: func(args args) {
				...
				mock.ExpectQuery(`INSERT INTO "users" (.+) VALUES (.+)`).
					WithArgs(
						...
						sqlmock.AnyArg(),
						args.models.Email,
						args.models.Username,
						args.models.Password,
						args.models.CreatedBy,
						args.models.UpdatedBy,
					).
		...
		{
			name: "Test Case 1 | error Create User",
			args: args{
				models: memberships.User{
					Email:     "Test@gmail.com",
					Username:  "Test",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := r.CreateUser(tt.args.models); (err != nil) != tt.wantErr {
...
func Test_repository_GetUser(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Test Case 1 | Success Get User",
			args: args{
				email:    "test@gmail.com",
		...
		{
			name: "Test Case 1 | Error Get User",
			args: args{
				email:    "test@gmail.com",
				username: "testusername",
				id:       1,
